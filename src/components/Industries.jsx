...
const industryData = {
  ...
  'Railway':                       { image: 'https://images.unsplash.com/photo-1474487548417-781cb6d646a3?auto=format&fit=crop&w=600&q=80', desc: 'Track & rolling stock fastening solutions' },
      ...
      <div className="container-main">
        <div className="mb-12">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <Link
              to="/industries"
              className="inline-flex items-center gap-2 shrink-0 text-sm font-semibold text-primary underline-offset-4 hover:underline"
            >
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-0 flex flex-col justify-end p-5">
                  ...
                  <p className="mt-1.5 max-h-0 overflow-hidden text-xs leading-5 text-white/85 opacity-0 transition-all duration-300 group-hover:max-h-10 group-hover:opacity-100">
                    {data.desc}
                  </p>
                </div>
              </motion.div>
