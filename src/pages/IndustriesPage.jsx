...
const industryDetails = [
  { name: 'Construction & Infrastructure', desc: 'Construction projects demand fasteners with exceptional load-bearing capacity, weather resistance, and dimensional precision. We supply structural hex bolts, anchor bolts, and high-tensile hardware for buildings, bridges, and infrastructure projects.', products: ['Structural Hex Bolts (Grade 8.8/10.9)', 'Anchor Bolts', 'Heavy Hex Nuts', 'Structural Washers F436', 'Threaded Rods'] },
  { name: 'Automotive', desc: 'The automotive industry requires fasteners that withstand vibration, thermal cycling, and high-stress loads. Our precision-grade fasteners meet OEM specifications for engine assemblies, chassis components, and interior fittings.', products: ['High Tensile Bolts', 'Flanged Nuts', 'Lock Nuts', 'Socket Head Cap Screws', 'Self Tapping Screws'] },
  { name: 'Aerospace', desc: 'Aerospace applications demand the highest precision tolerances, material certifications, and traceability. Our aerospace-grade fasteners meet the strictest international standards for critical flight components.', products: ['Titanium Bolts', 'Precision Socket Screws', 'Aircraft Grade Nuts', 'Close Tolerance Bolts', 'Locking Fasteners'] },
  { name: 'Shipbuilding & Marine', desc: 'Marine environments impose severe challenges including saltwater corrosion, biofouling, and extreme loads. Our marine-grade stainless steel fasteners provide long-term reliability in offshore and vessel applications.', products: ['316 Bolts & Nuts', 'Marine Grade Washers', 'Flanged Bolts', 'U-Bolts', 'Eye Bolts'] },
  { name: 'Oil & Gas', desc: 'Oil and gas installations require fasteners rated for high pressure, high temperature, and corrosive media. We supply API and ASTM grade fasteners for pipeline flanges, pressure vessels, and drilling equipment.', products: ['Stud Bolts with Nuts', 'ASTM A193 B7 Bolts', 'Heavy Hex Nuts A194 2H', 'B16.5 Flange Bolts', 'Spiral Wound Gaskets'] },
  { name: 'Heavy Machinery', desc: 'Heavy machinery manufacturing requires robust fasteners that withstand constant vibration, shock loads, and mechanical stress. Our Grade 10.9 and 12.9 bolts are engineered for demanding assembly line applications.', products: ['Grade 10.9 Hex Bolts', 'Grade 12.9 Socket Screws', 'Lock Washers', 'Prevailing Torque Nuts', 'T-Slot Bolts'] },
  { name: 'Railway', desc: 'Railway track and rolling stock fasteners must endure cyclic fatigue, vibration, and weathering over decades of service. We supply track bolts, fish bolts, and coach screws to railway standards.', products: ['Track Bolts & Nuts', 'Fish Bolts', 'Coach Screws', 'Spring Washers', 'Nyloc Lock Nuts'] },
  { name: 'Energy & Power', desc: 'Power generation facilities, from thermal plants to solar farms, need fasteners that perform reliably in thermal cycling, outdoor exposure, and high-vibration environments across decades of operation.', products: ['Structural Bolts', 'Solar Panel Mounting Bolts', 'Flange Bolts', 'Hex Nuts', 'Serrated Washers'] },
  { name: 'Electronics & Electrical', desc: 'Electronics manufacturing demands miniature, precisely machined fasteners with consistent thread quality. Our machine screws and standoffs meet the stringent requirements of PCB assembly, panel mounting, and enclosure fastening.', products: ['Miniature Machine Screws', 'Standoffs', 'Brass Inserts', 'CSK Phillips Screws', 'Pan Head Machine Screws'] },
  { name: 'HVAC', desc: 'HVAC systems require sheet metal screws, self-tapping fasteners, and duct hardware that install quickly and hold securely in thin gauge materials across a range of temperatures and environmental conditions.', products: ['Self Tapping Screws', 'Hex Head Sheet Metal Screws', 'Wafer Head Screws', 'Tek Screws', 'Duct Fasteners'] },
  { name: 'Telecommunications', desc: 'Telecommunications tower and equipment installations require fasteners with corrosion resistance, vibration locking, and dimensional precision for both indoor cabinet and outdoor tower mounting applications.', products: ['Stainless U-Bolts', 'Flange Bolts', 'Lock Nuts', 'Spring Washers', 'Tower Hardware Sets'] },
  { name: 'Engineering & Manufacturing', desc: 'General engineering and manufacturing encompasses a broad range of fastener requirements. We supply standard and custom fasteners for production lines, tooling, jigs, fixtures, and general assembly.', products: ['Socket Head Cap Screws', 'Hex Bolts & Nuts', 'Washers', 'Set Screws', 'Custom Machined Fasteners'] },
];
